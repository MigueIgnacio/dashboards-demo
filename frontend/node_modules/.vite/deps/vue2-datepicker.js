...
var formatFlags = {
  ...
  MMM: function MMM(date, locale4) {
    return locale4.monthsShort[date.getMonth()];
  },
  MMMM: function MMMM(date, locale4) {
    return locale4.months[date.getMonth()];
  },
  // Day of month: 1, 2, ..., 31
  D: function D(date) {
    return date.getDate();
  ...
  dd: function dd(date, locale4) {
    return locale4.weekdaysMin[date.getDay()];
  },
  // Day of week: 'Sun', 'Mon',..., 'Sat'
  ddd: function ddd(date, locale4) {
    return locale4.weekdaysShort[date.getDay()];
  },
  // Day of week: 'Sunday', 'Monday', ...,'Saturday'
  dddd: function dddd(date, locale4) {
    return locale4.weekdays[date.getDay()];
  },
  // AM, PM
  A: function A(date, locale4) {
    var meridiemFunc = locale4.meridiem || meridiem;
  ...
  w: function w(date, locale4) {
    return getWeek(date, {
      firstDayOfWeek: locale4.firstDayOfWeek,
      firstWeekContainsDate: locale4.firstWeekContainsDate
    });
  },
  ww: function ww(date, locale4) {
    return pad(formatFlags.w(date, locale4), 2);
  }
};
function format(val, str) {
  ...
  var locale4 = options.locale || en_default;
  return formatStr.replace(REGEX_FORMAT, function(match, p1) {
    if (p1) {
      return p1;
    }
    if (typeof formatFlags[match] === "function") {
      return "".concat(formatFlags[match](date, locale4));
    }
    return match;
  });
}
...
var addParseFlag = function addParseFlag2(token, regex, callback) {
  ...
  if (typeof callback === "string") {
    func = function func2(input) {
      ...
      return _defineProperty({}, callback, value3);
    };
  } else {
    func = callback;
  }
...
var matchWordRegExp = function matchWordRegExp2(localeKey) {
  return function(locale4) {
    var array = locale4[localeKey];
...
addParseFlag("YY", match2, function(input) {
  ...
  return _defineProperty({}, YEAR, value3);
});
...
function matchMeridiem(locale4) {
  return locale4.meridiemParse || /[ap]\.?m?\.?/i;
}
function defaultIsPM(input) {
  return "".concat(input).toLowerCase().charAt(0) === "p";
}
addParseFlag(["A", "a"], matchMeridiem, function(input, locale4) {
  var isPM = typeof locale4.isPM === "function" ? locale4.isPM(input) : defaultIsPM(input);
  return {
    isPM
  };
});
...
function makeParser(dateString, format2, locale4) {
  ...
  for (var i = 0; i < length; i += 1) {
    ...
    if (!parseTo) {
      ...
      var regex = typeof parseTo[0] === "function" ? parseTo[0](locale4) : parseTo[0];
      var parser = parseTo[1];
      var value3 = (regex.exec(dateString) || [])[0];
      var obj = parser(value3, locale4);
...
function _slicedToArray2(arr, i) {
  return _arrayWithHoles2(arr) || _iterableToArrayLimit2(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest2();
}
...
var mergeJsxProps = function mergeJsxProps2(a2) {
...
var mergeFn = function mergeFn2(a2, b) {
  return function() {
    a2 && a2.apply(this, arguments), b && b.apply(this, arguments);
  };
};
var helper = mergeJsxProps;
function createDate2(y) {
...
function isValidRangeDate(date) {
  return Array.isArray(date) && date.length === 2 && date.every(isValidDate2) && date[0] <= date[1];
}
function isValidDates(dates2) {
  return Array.isArray(dates2) && dates2.every(isValidDate2);
}
...
function getCalendar(_ref) {
  ...
  var arr = [];
  var calendar = createDate2(year, month, 0);
  ...
  for (var _i = 1; _i <= lastDayInCurrentMonth; _i++) {
    arr.push(createDate2(year, month, _i));
  }
  var lastMonthLength = lastDayInLastMonth - firstDayInLastMonth + 1;
  var nextMonthLength = 6 * 7 - lastMonthLength - lastDayInCurrentMonth;
  for (var _i2 = 1; _i2 <= nextMonthLength; _i2++) {
    arr.push(createDate2(year, month, lastDayInCurrentMonth + _i2));
  }
  return arr;
}
function setMonth(dirtyDate, dirtyMonth) {
  ...
  var year = date.getFullYear();
  var daysInMonth = createDate2(year, month + 1, 0).getDate();
...
function mergeDeep(target, source) {
  ...
  if (isObject(source)) {
    Object.keys(source).forEach(function(key) {
      ...
      result = _objectSpread2({}, result, _defineProperty2({}, key, value3));
    });
  }
  return result;
}
...
function locale2(name, object, isLocal) {
...
}, __vue_inject_styles__$1, {}, __vue_scope_id__$1, __vue_is_functional_template__$1, __vue_module_identifier__$1, false, void 0, void 0, void 0);
...
}, __vue_inject_styles__$2, {}, __vue_scope_id__$2, __vue_is_functional_template__$2, __vue_module_identifier__$2, false, void 0, void 0, void 0);
...
}, __vue_inject_styles__$3, {}, __vue_scope_id__$3, __vue_is_functional_template__$3, __vue_module_identifier__$3, false, void 0, void 0, void 0);
var script$1 = {
  props: {
    type: String,
    disabled: Boolean
...
}, __vue_inject_styles__$4, __vue_script__$1, __vue_scope_id__$4, __vue_is_functional_template__$4, __vue_module_identifier__$4, false, void 0, void 0, void 0);
var script$2 = {
  name: "TableDate",
  components: {
  ...
  computed: {
    ...
    days: function days() {
      var locale4 = this.getLocale();
      var days2 = locale4.days || locale4.formatLocale.weekdaysMin;
  ...
  methods: {
    ...
    handleCellClick: function handleCellClick(evt) {
      ...
      if (index) {
        ...
        }), _index$split$map2 = _slicedToArray2(_index$split$map, 2), row = _index$split$map2[0], col = _index$split$map2[1];
...
}, __vue_inject_styles__$5, __vue_script__$2, __vue_scope_id__$5, __vue_is_functional_template__$5, __vue_module_identifier__$5, false, void 0, void 0, void 0);
var script$3 = {
  name: "TableMonth",
  components: {
    IconButton: __vue_component__$4
  ...
  computed: {
    ...
    months: function months() {
      var locale4 = this.getLocale();
      var monthsLocale = locale4.months || locale4.formatLocale.monthsShort;
...
}, __vue_inject_styles__$6, __vue_script__$3, __vue_scope_id__$6, __vue_is_functional_template__$6, __vue_module_identifier__$6, false, void 0, void 0, void 0);
var script$4 = {
  name: "TableYear",
  components: {
    IconButton: __vue_component__$4
...
var __vue_scope_id__$7 = void 0;
var __vue_module_identifier__$7 = void 0;
var __vue_is_functional_template__$7 = false;
var __vue_component__$7 = normalizeComponent({
  render: __vue_render__$7,
  staticRenderFns: __vue_staticRenderFns__$7
}, __vue_inject_styles__$7, __vue_script__$4, __vue_scope_id__$7, __vue_is_functional_template__$7, __vue_module_identifier__$7, false, void 0, void 0, void 0);
var CalendarPanel = {
  name: "CalendarPanel",
  inject: {
    prefixClass: {
  ...
  computed: {
    innerValue: function innerValue() {
      ...
      return value3.filter(isValidDate2).map(function(v) {
        return start(v);
      });
    },
  ...
  methods: {
    ...
    handleSelectYear: function handleSelectYear(year) {
      if (this.type === "year") {
        ...
        this.handleCalendarChange(createDate2(year, this.calendarMonth), "year");
    ...
    handleSelectMonth: function handleSelectMonth(month) {
      if (this.type === "month") {
        ...
        this.handleCalendarChange(createDate2(this.calendarYear, month), "month");
    ...
    getMonthCellDate: function getMonthCellDate(month) {
      return createDate2(this.calendarYear, month);
    },
  ...
  render: function render() {
    ...
    return h2(__vue_component__$5, {
      ...
      "class": _defineProperty2({}, "".concat(this.prefixClass, "-calendar-week-mode"), this.type === "week"),
      "on": {
...
var CalendarRange = {
  ...
  methods: {
    handleSelect: function handleSelect(date, type) {
      var _this$innerValue = _slicedToArray2(this.innerValue, 2), startValue = _this$innerValue[0], endValue = _this$innerValue[1];
    ...
    getCalendarGap: function getCalendarGap(calendars) {
      var _calendars = _slicedToArray2(calendars, 2), calendarLeft = _calendars[0], calendarRight = _calendars[1];
    ...
    getRangeClasses: function getRangeClasses(cellDate, currentDates, classnames) {
      ...
      var inRange = function inRange2(data10, range) {
        ...
        var _range$map = range.map(fn), _range$map2 = _slicedToArray2(_range$map, 2), min = _range$map2[0], max = _range$map2[1];
        if (min > max) {
          var _ref = [max, min];
          min = _ref[0];
          max = _ref[1];
...
var __vue_scope_id__$8 = void 0;
var __vue_module_identifier__$8 = void 0;
var __vue_is_functional_template__$8 = false;
var __vue_component__$8 = normalizeComponent({
  render: __vue_render__$8,
  staticRenderFns: __vue_staticRenderFns__$8
}, __vue_inject_styles__$8, __vue_script__$5, __vue_scope_id__$8, __vue_is_functional_template__$8, __vue_module_identifier__$8, false, void 0, void 0, void 0);
...
var __vue_scope_id__$9 = void 0;
var __vue_module_identifier__$9 = void 0;
var __vue_is_functional_template__$9 = false;
var __vue_component__$9 = normalizeComponent({
  render: __vue_render__$9,
  staticRenderFns: __vue_staticRenderFns__$9
}, __vue_inject_styles__$9, __vue_script__$6, __vue_scope_id__$9, __vue_is_functional_template__$9, __vue_module_identifier__$9, false, void 0, void 0, void 0);
...
var __vue_scope_id__$a = void 0;
var __vue_module_identifier__$a = void 0;
var __vue_is_functional_template__$a = false;
var __vue_component__$a = normalizeComponent({
  render: __vue_render__$a,
  staticRenderFns: __vue_staticRenderFns__$a
}, __vue_inject_styles__$a, __vue_script__$7, __vue_scope_id__$a, __vue_is_functional_template__$a, __vue_module_identifier__$a, false, void 0, void 0, void 0);
var script$8 = {
  name: "TimePanel",
  components: {
...
var __vue_scope_id__$b = void 0;
var __vue_module_identifier__$b = void 0;
var __vue_is_functional_template__$b = false;
var __vue_component__$b = normalizeComponent({
  render: __vue_render__$b,
  staticRenderFns: __vue_staticRenderFns__$b
}, __vue_inject_styles__$b, __vue_script__$8, __vue_scope_id__$b, __vue_is_functional_template__$b, __vue_module_identifier__$b, false, void 0, void 0, void 0);
var TimeRange = {
  name: "TimeRange",
  inject: {
    prefixClass: {
    ...
    value: {
      ...
      handler: function handler5() {
        if (isValidRangeDate(this.value)) {
          var _this$value = _slicedToArray2(this.value, 2), startValue = _this$value[0], endValue = _this$value[1];
...
var DatePicker = {
  ...
  methods: {
    ...
    date2value: function date2value(date) {
      if (!isValidDate2(date)) return null;
      switch (this.valueType) {
        case "date":
          return date;
        case "timestamp":
  ...
  render: function render6() {
    ...
    return h2("div", {
      "class": (_class = {}, _defineProperty2(_class, "".concat(prefixClass, "-datepicker"), true), _defineProperty2(_class, "".concat(prefixClass, "-datepicker-range"), this.range), _defineProperty2(_class, "".concat(prefixClass, "-datepicker-inline"), inline), _defineProperty2(_class, "disabled", disabled), _class)
...
var index_esm_default = DatePicker;
export {
  index_esm_default as default
};
//# sourceMappingURL=vue2-datepicker.js.map
